...
object KafkaConfig {
    ...
    val RequestTimeoutMsProp: String = CommonClientConfigs.REQUEST_TIMEOUT_MS_CONFIG
    /** *********** Authorizer Configuration ***********/
...
class KafkaConfig(val props: java.util.Map[_, _], doLog: Boolean) extends AbstractConfig(KafkaConfig.configDef, props, doLog) {
    ...
    val numNetworkThreads: Integer = getInt(KafkaConfig.NumNetworkThreadsProp)
    val backgroundThreads: Integer = getInt(KafkaConfig.BackgroundThreadsProp)
    val queuedMaxRequests: Integer = getInt(KafkaConfig.QueuedMaxRequestsProp)
    val numIoThreads: Integer = getInt(KafkaConfig.NumIoThreadsProp)
    val messageMaxBytes: Integer = getInt(KafkaConfig.MessageMaxBytesProp)
    val requestTimeoutMs: Integer = getInt(KafkaConfig.RequestTimeoutMsProp)
    ...
    val socketReceiveBufferBytes: Integer = getInt(KafkaConfig.SocketReceiveBufferBytesProp)
    val socketRequestMaxBytes: Integer = getInt(KafkaConfig.SocketRequestMaxBytesProp)
    val maxConnectionsPerIp: Integer = getInt(KafkaConfig.MaxConnectionsPerIpProp)
    ...
    val connectionsMaxIdleMs: lang.Long = getLong(KafkaConfig.ConnectionsMaxIdleMsProp)

    /** *************** rack configuration **************/
    val rack = Option(getString(KafkaConfig.RackProp))

    /** ********* Log Configuration ***********/
    val autoCreateTopicsEnable: lang.Boolean = getBoolean(KafkaConfig.AutoCreateTopicsEnableProp)
    val numPartitions: Integer = getInt(KafkaConfig.NumPartitionsProp)
    ...
    val logSegmentBytes: Integer = getInt(KafkaConfig.LogSegmentBytesProp)
    val logFlushIntervalMessages: lang.Long = getLong(KafkaConfig.LogFlushIntervalMessagesProp)
    ...
    val replicaLagTimeMaxMs: lang.Long = getLong(KafkaConfig.ReplicaLagTimeMaxMsProp)
    val replicaSocketTimeoutMs: Integer = getInt(KafkaConfig.ReplicaSocketTimeoutMsProp)
    val replicaSocketReceiveBufferBytes: Integer = getInt(KafkaConfig.ReplicaSocketReceiveBufferBytesProp)
    val replicaFetchMaxBytes: Integer = getInt(KafkaConfig.ReplicaFetchMaxBytesProp)
    val replicaFetchWaitMaxMs: Integer = getInt(KafkaConfig.ReplicaFetchWaitMaxMsProp)
    val replicaFetchMinBytes: Integer = getInt(KafkaConfig.ReplicaFetchMinBytesProp)
    val replicaFetchResponseMaxBytes: Integer = getInt(KafkaConfig.ReplicaFetchResponseMaxBytesProp)
    val replicaFetchBackoffMs: Integer = getInt(KafkaConfig.ReplicaFetchBackoffMsProp)
    val numReplicaFetchers: Integer = getInt(KafkaConfig.NumReplicaFetchersProp)
    val replicaHighWatermarkCheckpointIntervalMs: lang.Long = getLong(KafkaConfig.ReplicaHighWatermarkCheckpointIntervalMsProp)
    val fetchPurgatoryPurgeIntervalRequests: Integer = getInt(KafkaConfig.FetchPurgatoryPurgeIntervalRequestsProp)
    val producerPurgatoryPurgeIntervalRequests: Integer = getInt(KafkaConfig.ProducerPurgatoryPurgeIntervalRequestsProp)
    val autoLeaderRebalanceEnable: lang.Boolean = getBoolean(KafkaConfig.AutoLeaderRebalanceEnableProp)
    val leaderImbalancePerBrokerPercentage: Integer = getInt(KafkaConfig.LeaderImbalancePerBrokerPercentageProp)
    val leaderImbalanceCheckIntervalSeconds: lang.Long = getLong(KafkaConfig.LeaderImbalanceCheckIntervalSecondsProp)
