...
object Topic {
    ...
    /** 内部 topic 集合，目前只有 consumer_offsets 这一个 */
    val InternalTopics: Set[String] = immutable.Set(GroupMetadataTopicName)
     ...
     * @return
     */
    def isInternal(topic: String): Boolean = InternalTopics.contains(topic)
