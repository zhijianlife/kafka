...
object Message {
    ...
    val CrcOffset = 0
    val CrcLength = 4
    val MagicOffset: Int = CrcOffset + CrcLength
    val MagicLength = 1
    val AttributesOffset: Int = MagicOffset + MagicLength
    val AttributesLength = 1
    // Only message format version 1 has the timestamp field.
    val TimestampOffset: Int = AttributesOffset + AttributesLength
    val TimestampLength = 8
    val KeySizeOffset_V0: Int = AttributesOffset + AttributesLength
    val KeySizeOffset_V1: Int = TimestampOffset + TimestampLength
    val KeySizeLength = 4
    val KeyOffset_V0: Int = KeySizeOffset_V0 + KeySizeLength
    val KeyOffset_V1: Int = KeySizeOffset_V1 + KeySizeLength
     ...
     */
    val MinMessageOverhead: Int = KeyOffset_V0 + ValueSizeLength
    ...
    def fromRecord(record: Record): Message = {
        val wrapperTimestamp: Option[Long] = Option(record.wrapperRecordTimestamp)
